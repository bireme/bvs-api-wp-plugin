    ...
    public function renderMainPage(): void
    {
        ...
        <div class="wrap" style="max-width: 100%;">
            ...
            <div class="card" style="margin-bottom: 20px;">
                ...
                <p><?php esc_html_e('Plugin WordPress para integração com a API BVS Saúde, permitindo exibir recursos através de shortcode genérico personalizável.', 'bvsalud-integrator'); ?></p>
            </div>
            ...
            <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                ...
                <div class="card" style="flex: 1; min-width: 300px;">
                    ...
                    <code style="display: block; background: #f1f1f1; padding: 10px; margin: 10px 0;">[bvs_resources type="TIPO" parâmetros...]</code>
                ...
                <div class="card" style="flex: 1; min-width: 300px;">
                    ...
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 8px;"><code>[bvs_resources type="journals" country="Brazil" limit="10"]</code></li>
                        <li style="margin-bottom: 8px;"><code>[bvs_resources type="webResources" show_filters="true"]</code></li>
            ...
            <div style="display: flex; gap: 20px; margin-top: 20px;">
                ...
                <div class="card" style="flex: 1; min-width: 300px;">
                    ...
                    <p><?php esc_html_e('Configure os recursos da API BVS Saúde com suas respectivas URLs e token de acesso.', 'bvsalud-integrator'); ?></p>
                    <p><strong><?php esc_html_e('Acesse:', 'bvsalud-integrator'); ?></strong> <a href="<?php echo admin_url('admin.php?page=bvsalud-integrator-settings'); ?>"><?php esc_html_e('BVSalud > Configurações', 'bvsalud-integrator'); ?></a></p>
                </div>
            </div>
            ...
            <div class="card" style="margin-top: 20px;">
                ...
                <p><?php esc_html_e('Para mais exemplos e documentação detalhada, consulte o arquivo README.md no diretório do plugin.', 'bvsalud-integrator'); ?></p>
            </div>
        </div>
        <?php
    }
